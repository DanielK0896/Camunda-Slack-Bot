/* These file can be reached by calling swagger API endpoint. Pass as many variables as you want to add to Camunda as a process variable.
...
function camundaSendMessage(req, res) {
    ...
    for (var i = 0; i <= nameVariable.length; i++) {
        body.processVariables.push([msg.nameVariable[i]]: { "value": msg.variable[i], "type": "String" }); 
    }    
