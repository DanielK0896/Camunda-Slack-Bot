...
function camundaInstanceGetId(req, res) {
    ...
    var URL = "http://automation.cct-ev.de/engine-rest/process-instance" + "?variables=" + correlationKeys[0]+ "_eq_" + correlationKeys[2] + "," + correlationKeys[1] + "_eq_" + correlationKeys[3];
    var options = {
        method: 'GET',
        url: URL
    };
